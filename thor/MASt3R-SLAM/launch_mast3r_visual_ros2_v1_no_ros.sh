#!/bin/bash
# Launch MASt3R-SLAM Node for Stretch3 Robot (IPC Only / No ROS)
set -e

echo "🚀 Starting MASt3R-SLAM for Stretch3 Robot (IPC Interface)"
echo "========================================================"
...
if [ ! -f "mast3r_slam_visual_ros2_improved_no_ros.py" ]; then
    echo "❌ Error: mast3r_slam_visual_ros2_improved_no_ros.py not found"
...
python3 mast3r_slam_visual_ros2_improved_no_ros.py
