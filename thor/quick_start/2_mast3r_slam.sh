...
ROBOT_ROSBRIDGE_PORT=${ROBOT_ROSBRIDGE_PORT:-9091}
...
MAST3R_MAX_FPS=${MAST3R_MAX_FPS:-30.0}
...
export MAST3R_FULLMAP_RAW_POINTCLOUD_TOPIC
...
echo "  MAST3R_FULLMAP_RAW_POINTCLOUD_TOPIC: $MAST3R_FULLMAP_RAW_POINTCLOUD_TOPIC"
