...
MIN_CONSTRAINT_INLIER_RATIO=${MIN_CONSTRAINT_INLIER_RATIO:-0.55}
MAX_CONSTRAINTS_PER_KEYFRAME=${MAX_CONSTRAINTS_PER_KEYFRAME:-1}
MIN_USED_CONSTRAINTS_PER_PAIR=${MIN_USED_CONSTRAINTS_PER_PAIR:-2}
...
echo "  MIN_CONSTRAINT_INLIER_RATIO: $MIN_CONSTRAINT_INLIER_RATIO"
echo "  MAX_CONSTRAINTS_PER_KEYFRAME: $MAX_CONSTRAINTS_PER_KEYFRAME"
echo "  MIN_USED_CONSTRAINTS_PER_PAIR: $MIN_USED_CONSTRAINTS_PER_PAIR"
...
ROS_ARGS=(
    ...
    -p min_constraint_inlier_ratio:="$MIN_CONSTRAINT_INLIER_RATIO"
    -p max_constraints_per_keyframe:="$MAX_CONSTRAINTS_PER_KEYFRAME"
    -p min_used_constraints_per_pair:="$MIN_USED_CONSTRAINTS_PER_PAIR"
